...
plotRisks(risks, countries, adm0, "global_Overall_prediction", "Global relative risk of Ebola importation\n from overall model")

risks <- data.frame(country=countrycodes, risk=all$adjacency_relative)
plotRisks(risks, countries, adm0, "global_Adjacency_prediction", "Global relative risk of Ebola importation\n from Adjacency model")

risks <- data.frame(country=countrycodes, risk=all$gravity_relative)
plotRisks(risks, countries, adm0, "global_Gravity_prediction", "Global relative risk of Ebola importation\n from Gravity model")

risks <- data.frame(country=countrycodes, risk=all$migration_relative)
plotRisks(risks, countries, adm0, "global_Migration_prediction", "Global relative risk of Ebola importation\n from Migration model")
